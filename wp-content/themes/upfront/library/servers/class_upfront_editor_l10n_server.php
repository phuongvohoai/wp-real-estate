	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			'application' => array(
				...
				'rendering' => __('Rendering %s%', 'upfront'),
				'rendering_success' => __('All done!', 'upfront'),
			...
			'content' => array(
				...
				'dial_number' => __('Dial Number', 'upfront'),
				'url' => __('URL', 'upfront'),
				...
				'template_nag' => __('Your current layout has changes that are not saved in the <span class="template_name">Default Template</span>. Clicking <strong>Overwrite Template</strong> will apply those changes to <span class="template_name">Default Template</span> (for future posts only).', 'upfront'),
				'reset_changes_nag' => __('Clicking <strong>Reset Changes</strong> will remove all your current changes and will load <span class="template_name">Default Template</span>.', 'upfront'),
				...
				'update_template' => __('Overwrite Template', 'upfront'),
				'reset_changes' => __('Reset Changes', 'upfront'),
			...
			'ueditor' => array(
				...
				'choose_image_insert' => __('Image Insert: ', Upfront::TextDomain),
			...
			'views' => array(
				...
				'multiple_tabs_nag' => __('Another tab is already working on this.', 'upfront'),
				'trash' => __('Trash', 'upfront'),
				'save' => __('Save', 'upfront'),
				'save_element' => __('Save Element', 'upfront'),
				...
				'edit_global_bg' => __('Global Theme BG', 'upfront'),
                'edit_global_regions' => __('Edit Global Regions', 'upfront'),
				'add_custom_css_rules' => __('Global Theme CSS', 'upfront'),
				...
				'page_settings' => __('Page Settings', 'upfront'),
				'post_details' => __('Post Details', 'upfront'),
				'page_details' => __('Page Details', 'upfront'),
                ...
                'group_settings' => __('Group Settings', 'upfront'),
                'group_bg' => __('Group Background', 'upfront'),
				'background_type' => __('Background Type', 'upfront'),
				...
				'featured_default_color' => __('Color', 'upfront'),
				'featured_default_image' => __('Image', 'upfront'),
				'featured_default_hide' => __('Hide', 'upfront'),
				...
				'global_bg' => __('Global Background', 'upfront'),
				...
				'bg_changed_prompt' => __('You have modified the Desktop Background for %s. Would you like to update tablet & mobile breakpoints to also use this Background?', 'upfront'),
				'bg_changed_confirm' => __('Yes', 'upfront'),
				'bg_changed_cancel' => __('No', 'upfront'),
				...
				'theme_colors_opacity_disabled' => __('No Opacity for Theme Colors', 'upfront'),
